...
print("FINEEEEE")
dir.create("./data/Permutation")
dir.create(paste("./data/Permutation/", index,sep=""))
write.table(clustering.output[,2],paste("./data/Permutation/",index,"/clusterB_",index,".",format,sep=""),sep=separator, quote=FALSE)

write.table(killedCell,paste("./data/Permutation/",index,"/killC_",index,".",format,sep=""),sep=separator, quote=FALSE)
