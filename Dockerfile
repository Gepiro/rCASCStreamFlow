...
MAINTAINER gepiro0916@gmail.com
...
RUN R CMD INSTALL --build /tmp/tmp/doBy_4.5-15.tar.gz \
   /tmp/tmp/DBI_0.6-1.tar.gz \
   /tmp/tmp/digest_0.6.12.tar.gz \
   /tmp/tmp/memoise_1.1.0.tar.gz \
   /tmp/tmp/Rcpp_0.12.11.tar.gz \
   /tmp/tmp/BH_1.72.0-3.tar.gz \
   /tmp/tmp/plogr_0.2.0.tar.gz \
   /tmp/tmp/RSQLite_1.1-2.tar.gz \
   /tmp/tmp/refGenome_1.7.3.tar.gz \
   /tmp/tmp/data.table_1.13.4.tar.gz
...
RUN R CMD INSTALL --build /tmp/tmp/xopen_1.0.0.tar.gz \
   /tmp/tmp/rcmdcheck_1.3.3.tar.gz \
   /tmp/tmp/devtools_2.3.2.tar.gz \
   /tmp/tmp/QUIC_1.1.tar.gz 
